...
namespace AquaCulture
{
    ...
    {
        SerializedProperty m_OnTakingControlProp;
        SerializedProperty m_OnReleasingControlProp;
        ...
        void OnEnable ()
        {
            m_OnTakingControlProp = serializedObject.FindProperty( "OnTakingControl" );
            m_OnReleasingControlProp = serializedObject.FindProperty( "OnReleasingControl" );
        ...
        public override void OnInspectorGUI ()
        {
            ...
            EditorGUILayout.PropertyField( m_OnTakingControlProp );
            EditorGUILayout.PropertyField( m_OnReleasingControlProp );
