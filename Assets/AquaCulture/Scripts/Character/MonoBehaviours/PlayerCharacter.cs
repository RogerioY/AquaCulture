...
namespace AquaCulture
{
    ...
    public class PlayerCharacter : MonoBehaviour
    {
        ...
        public WwiseFootstepController footstepAudioPlayer;
        ...
        protected readonly int m_HashInteractPara = Animator.StringToHash("Interact");
        ...
        {
            m_CharacterController2D.Rigidbody2D.simulated = Toggle;
        }
            ...
            if (grounded)
            {
                ...
                {//only play the landing sound if falling "fast" enough (avoid small bump playing the landing sound)
                 // landingAudioPlayer.PlayRandomSound(m_CurrentSurface);
                  ...
                  footstepAudioPlayer.PlayWwiseFootstep(m_CurrentSurface);
                }
            }
            else
        ...
        {
            return PlayerInput.Instance.Interact.Down;
        }

        public void Interact()
        {
            m_Animator.SetTrigger( m_HashInteractPara );
        }
        ...
        // YJ 2018: Interacts are attacks in disguise.
